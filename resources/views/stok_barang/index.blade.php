    ...
    <div x-data="stokBarang()" x-init="init()" class="p-6 max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div @click="openShelf(rack)"
                    ...
                    <div class="mb-3 flex justify-center">
                        <template x-if="rack.icon_component">
                            <component :is="`x-heroicon-o-${rack.icon_component}`" class="w-8 h-8 text-blue-400">
                            </component>
                        </template>
                    </div>
            ...
            <template x-if="!isLoading && shelves.length === 0">
                <div
                    class="col-span-full text-center py-16 flex flex-col items-center justify-center text-gray-400 dark:text-gray-500">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Tambahkan rak baru untuk mulai menyimpan
                        produk.</p>
                </div>
            </template>
                        ...
                        <template x-for="(product, i) in filteredProducts" :key="i">
                            <div x-transition:enter="transition ease-out duration-300"
                                ...
                                <div class="flex justify-between items-center mb-3">
                                    <div>
                                        <h4 class="font-semibold text-gray-800 dark:text-gray-100" x-text="product.name">
                                        </h4>
                                    ...
                                    <template x-for="attr in product.attributes" :key="attr.name + attr.value">
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <span class="text-gray-500" x-text="attr.value"></span>
                                            </div>
                                            <div class="text-gray-600 dark:text-gray-300">
                                                <span x-text="attr.stok"></span> pcs
                                            </div>
                                        </div>
                                    </template>
