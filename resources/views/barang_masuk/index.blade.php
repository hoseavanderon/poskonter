        ...
        <div x-show="showConfirmLeaveModal" x-transition
            ...
            <div class="bg-[#1B2332] w-full max-w-md rounded-2xl p-6 border border-[#2A3242]">
                ...
                <p class="text-gray-400 mb-5">
                    Data yang kamu input akan otomatis disimpan sebagai draft.
                    Kamu bisa kembali lagi tanpa kehilangan data.
                </p>
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button @click="confirmLeave()" class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-400">
                        Lanjutkan & Tinggalkan Halaman
                    </button>
                </div>
            </div>
        </div>
