    ...
    <div x-data="{
        ...
        <div x-data="bottomNav()" x-init="init()"
            ...
            <div
                ...
                <!-- ACTIVE INDICATOR -->
                <div class="absolute left-0 top-1 bottom-1 rounded-xl bg-white/10 
                    transition-[transform,width] duration-300 ease-out will-change-transform"
                    :style="`width:${width}px; transform:translateX(${left}px)`">
                </div>

                <!-- HOME -->
                <button data-page="home" @click="select('home', $event)"
                    class="relative z-10 flex justify-center w-full">
                ...
                <!-- PRODUK -->
                <button data-page="product" @click="select('product', $event)"
                    class="relative z-10 flex justify-center w-full">
                ...
                <!-- INSIGHT -->
                <button data-page="insight" @click="select('insight', $event)"
                    class="relative z-10 flex justify-center w-full">
                ...
                <!-- SETTINGS -->
                <button data-page="settings" @click="select('settings', $event)"
                    class="relative z-10 flex justify-center w-full">
                    ...
                    <div class="flex flex-col items-center text-xs px-4 py-1"
                        ...
                        <svg class="w-5 h-5 mb-1" fill="none" stroke="currentColor" stroke-width="1.8"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M10.325 4.317a1 1 0 011.35-.936l1.7.98a1 1 0 001.1 0l1.7-.98a1 1 0 011.35.936l.325 1.89a1 1 0 00.757.77l1.89.325a1 1 0 01.936 1.35l-.98 1.7a1 1 0 000 1.1l.98 1.7a1 1 0 01-.936 1.35l-1.89.325a1 1 0 00-.770.757l-.325 1.89a1 1 0 01-1.35.936l-1.7-.98a1 1 0 00-1.1 0l-1.7.98a1 1 0 01-1.35-.936l-.325-1.89a1 1 0 00-.757-.77l-1.89-.325a1 1 0 01-.936-1.35l.98-1.7a1 1 0 000-1.1l-.98-1.7a1 1 0 01.936-1.35l1.89-.325a1 1 0 00.77-.757l.325-1.89z" />
                        </svg>
